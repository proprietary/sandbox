// tests:
// clang++ -std=c++17 -lgtest -lgtest_main -pthread
// com_leetcode_problems_best_time_to_buy_and_sell_stock.cc && ./a.out
// benchmarks:
// clang++ -std=c++17 -lbenchmark -lbenchmark_main -lgtest -pthread
// com_leetcode_problems_best_time_to_buy_and_sell_stock.cc && ./a.out
...
TEST(Leetcode, TestAgainstQuadratic) {
  ...
  for (int i = 0; i < iters; ++i) {
    ...
    if (expected != actual) {
      fmt::print("vector: {}", fmt::join(v.begin(), v.end(), ", "));
    }
